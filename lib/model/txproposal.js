...
TxProposal.prototype._buildTx = function() {
  ...
  var totalInputs = _.sum(t.inputs, 'output.atoms');
  var totalOutputs = _.sum(t.outputs, 'atoms');
...
TxProposal.prototype.getEstimatedSizeForSingleInput = function() {
  switch (this.addressType) {
    ...
    default:
    case Constants.SCRIPT_TYPES.P2SH:
      return this.requiredSignatures * 90 + this.walletN * 50 + 44;
  }
};
...
TxProposal.prototype.getEstimatedSize = function() {
  ...
  var size =  12 + 4 + 2 + nbInputs*this.getEstimatedSizeForSingleInput() + nbOutputs*P2PKHOutputSize;
  return size;
};
